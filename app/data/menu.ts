...
const RAW: MenuItem[] = [
  ...
  {cat:"Sin Alcohol",name:"Virgin Mai Tai",hasIngr:true,
   ingr:["Tanqueray 0.0","Sirope de orgeat","Sirope falernum","Zumo de limón","Zumo de naranja"],
   optional:["Rodaja de limón","Hierbabuena"],
   doses:{"Tanqueray 0.0":"2 oz","Sirope de orgeat":"1.5 oz","Sirope falernum":"1.5 oz","Zumo de limón":"1 oz","Zumo de naranja":"0.5 oz"},
   method:"Escarcha el vaso con granadina. Añade el resto de ingredientes con hielo y remueve. Decora con una rodaja de limón y hierbabuena.",
