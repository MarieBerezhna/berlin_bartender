...
const RAW: MenuItem[] = [
  ...
  {cat:"Coctelería clásica",name:"Daiquiri",family:"Daiquiri",hasIngr:true,
   ...
   method:"Añade todos los ingredientes a una coctelera con hielo. Agita enérgicamente. Cuela en una copa coupé previamente enfriada.",
   glass:"Coupe / Martini",
   prices:[{label:"cóctel",p:11}]},
  {cat:"Coctelería clásica",name:"Whiskey Sour",family:"Daiquiri",hasIngr:true,
   ingr:["Bourbon","Zumo de limón","Azúcar líquido","Clara de huevo"],
   optional:["Clara de huevo"],
   doses:{"Bourbon":"2 oz","Zumo de limón":"1 oz","Azúcar líquido":"0.75 oz"},
   method:"Si utilizas clara de huevo, realiza un dry shake (agitar sin hielo). Añade hielo y vuelve a agitar enérgicamente. Cuela en un vaso bajo con hielo o en una copa coupé.",
   glass:"Vaso bajo",
   prices:[{label:"cóctel",p:11}]},
  {cat:"Coctelería clásica",name:"Tom Collins",family:"Daiquiri",hasIngr:true,
   ingr:["Ginebra","Zumo de limón","Azúcar líquido","Soda"],
   doses:{"Ginebra":"2 oz","Zumo de limón":"1 oz","Azúcar líquido":"0.5 oz","Soda":"top"},
   method:"Añade la ginebra, el zumo de limón y el azúcar líquido a una coctelera con hielo. Agita enérgicamente. Cuela en un vaso Collins con hielo y completa con soda.",
   glass:"Collins (tubo)",
   prices:[{label:"cóctel",p:11}]},
  {cat:"Coctelería clásica",name:"Army & Navy",family:"Daiquiri",hasIngr:true,
   ingr:["Ginebra","Zumo de limón","Sirope de orgeat","Angostura Bitters"],
   doses:{"Ginebra":"2 oz","Zumo de limón":"0.75 oz","Sirope de orgeat":"0.5 oz","Angostura Bitters":"2 dashes"},
   method:"Añade todos los ingredientes a una coctelera con hielo. Agita enérgicamente. Cuela en una copa coupé previamente enfriada.",
   glass:"Coupe / Martini",
   prices:[{label:"cóctel",p:11}]},
  ...
  {cat:"Coctelería clásica",name:"Moscow Mule",family:"Highball",hasIngr:true,
   ingr:["Vodka","Zumo de lima","Ginger beer"],
   doses:{"Vodka":"2 oz","Zumo de lima":"0.5 oz","Ginger beer":"top"},
   method:"Añade el vodka y el zumo de lima a un vaso con hielo. Completa con ginger beer y remueve suavemente.",
   glass:"Vaso largo",
   prices:[{label:"cóctel",p:11}]},
  {cat:"Coctelería clásica",name:"Dark 'n' Stormy",family:"Highball",hasIngr:true,
   ...
   method:"Llena un vaso con hielo. Añade el ron, completa con ginger beer y remueve suavemente.",
   glass:"Vaso largo",
   prices:[{label:"cóctel",p:11}]},
  {cat:"Coctelería clásica",name:"Paloma",family:"Highball",hasIngr:true,
   ingr:["Tequila","Zumo de lima","Refresco de pomelo"],
   doses:{"Tequila":"2 oz","Zumo de lima":"0.5 oz","Refresco de pomelo":"top"},
   method:"Llena un vaso con hielo. Añade el tequila y el zumo de lima, completa con refresco de pomelo y remueve suavemente.",
   glass:"Vaso largo",
   prices:[{label:"cóctel",p:11}]},
  {cat:"Coctelería clásica",name:"Cuba Libre",family:"Highball",hasIngr:true,
   ingr:["Ron blanco","Zumo de lima","Cola"],
   doses:{"Ron blanco":"2 oz","Zumo de lima":"0.5 oz","Cola":"top"},
   method:"Añade el ron blanco y el zumo de lima a un vaso con hielo. Completa con cola y remueve suavemente.",
   glass:"Vaso largo",
   prices:[{label:"cóctel",p:11}]},
  ...
  {cat:"Coctelería clásica",name:"Old Fashioned",family:"Old Fashioned",hasIngr:true,
   ingr:["Whisky","Azúcar líquido","Angostura Bitters","Naranja"],
   optional:["Naranja"],
   doses:{"Whisky":"2 oz","Azúcar líquido":"1.5 tsp","Angostura Bitters":"2 dashes"},
   method:"Removido con hielo, colado sobre cubo grande",
  glass:"Vaso bajo",
   prices:[{label:"cóctel",p:11}]},
  {cat:"Coctelería clásica",name:"Trinidad",family:"Old Fashioned",hasIngr:true,
    ingr:["Angostura Bitters","Whisky","Azúcar líquido","Bitter de naranja"],
    doses:{"Angostura Bitters":"3 oz","Whisky":"1 oz","Azúcar líquido":"0.5 oz","Bitter de naranja":"2 dashes"},
   method:"Remover y colar sobre un cubo grande de hielo.",
   glass:"Vaso bajo",
   prices:[{label:"cóctel",p:11}]},
  {cat:"Coctelería clásica",name:"Revolver",family:"Old Fashioned",hasIngr:true,
   ingr:["Bourbon","Licor de café Bols","Bitter de naranja","Naranja"],
   optional:["Naranja"],
   doses:{"Bourbon":"2 oz","Licor de café Bols":"0.5 oz","Bitter de naranja":"2 dashes"},
   method:"Añade todos los ingredientes a un vaso mezclador con hielo. Remueve hasta que esté bien frío. Cuela en una copa coupé previamente enfriada.",
   glass:"Coupe / Martini",
   prices:[{label:"cóctel",p:11}]},
  {cat:"Coctelería clásica",name:"Tequila Old Fashioned",family:"Old Fashioned",hasIngr:true,
   ...
   method:"Añade todos los ingredientes a un vaso mezclador con hielo. Remueve hasta que esté bien frío. Cuela sobre un cubo grande de hielo en un vaso bajo.",
   glass:"Vaso bajo",
   prices:[{label:"cóctel",p:11}]},
  {cat:"Coctelería clásica",name:"Martini",family:"Martini",hasIngr:true,
   ingr:["Gin","Vermut","Limón"],
   optional:["Limón"],
   doses:{"Gin":"2 oz","Vermut":"1 oz"},
   method:"Remover y colar",
   glass:"Copa Martini",
   prices:[{label:"cóctel",p:11}]},
  {cat:"Coctelería clásica",name:"Negroni",family:"Inclasificables",hasIngr:true,
   ...
   method:"Remover y servir sobre cubo grande de hielo",
   glass:"Vaso bajo",
   prices:[{label:"cóctel",p:11}]},
  {cat:"Coctelería clásica",name:"Boulevardier",family:"Inclasificables",hasIngr:true,
   ...
   doses:{"Whisky":"2 oz","Campari":"2 oz","Vermut tinto":"2 oz"},
    method:"Remover y servir sobre hielo.",
   prices:[{label:"cóctel",p:11}]},
  {cat:"Coctelería clásica",name:"Manhattan",family:"Inclasificables",hasIngr:true,
   ...
   method:"Remover y colar en la copa. Decorar con una cereza.",
   glass:"Coupe / Martini",
   prices:[{label:"cóctel",p:11}]},
  {cat:"Coctelería clásica",name:"El Presidente",family:"Martini",hasIngr:true,
   ingr:["Ron blanco","Vermut seco","Curaçao","Granadina"],
    doses:{"Ron blanco":"3 oz","Vermut seco":"1.5 oz","Curaçao":"1 oz","Granadina":"1 tsp"},
   method:"Remover y colar en la copa.",
   glass:"Coupe / Martini",
   prices:[{label:"cóctel",p:11}]},
  ...
  {cat:"Coctelería clásica",name:"Margarita",family:"Sidecar",hasIngr:true,
   ingr:["Tequila blanco","Triple sec","Zumo de lima","Sal"],
   optional:["Sal"],
   doses:{"Tequila blanco":"2 oz","Triple sec":"1 oz","Zumo de lima":"1 oz"},
   method:"Añade todos los ingredientes a una coctelera con hielo. Agita enérgicamente. Cuela en una copa coupé o en un vaso bajo con hielo.",
   glass:"Coupe / Martini",
   prices:[{label:"cóctel",p:11}]},
  {cat:"Coctelería clásica",name:"White Lady",family:"Sidecar",hasIngr:true,
   ingr:["Ginebra","Triple sec","Zumo de limón"],
   doses:{"Ginebra":"2 oz","Triple sec":"1 oz","Zumo de limón":"0.75 oz"},
   method:"Añade todos los ingredientes a una coctelera con hielo. Agita enérgicamente. Cuela en una copa coupé previamente enfriada.",
   glass:"Coupe / Martini",
   prices:[{label:"cóctel",p:11}]},
  {cat:"Coctelería clásica",name:"Aviation",family:"Sidecar",hasIngr:true,
   ingr:["Ginebra","Licor de maraschino","Crème de violette","Zumo de limón"],
   doses:{"Ginebra":"2 oz","Licor de maraschino":"0.5 oz","Crème de violette":"0.25 oz","Zumo de limón":"0.75 oz"},
   method:"Añade todos los ingredientes a una coctelera con hielo. Agita enérgicamente. Cuela en una copa coupé previamente enfriada.",
   glass:"Coupe / Martini",
   prices:[{label:"cóctel",p:11}]},
