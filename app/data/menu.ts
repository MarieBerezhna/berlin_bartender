...
const RAW: MenuItem[] = [
  ...
  {cat:"Coctelería clásica",name:"Whiskey Sour",family:"Daiquiri",hasIngr:true,
    ingr:["Whisky (o Bourbon)","Zumo de limón","Azúcar líquido","Clara de huevo"],
  ...
  {cat:"Coctelería clásica",name:"Paloma",family:"Highball",hasIngr:true,
    ...
    method:"Llena un vaso con hielo. Añade el tequila y el zumo de lima, completa con soda de pomelo y remueve suavemente.",
   glass:"Vaso largo",
   prices:[{label:"cóctel",p:11}]},
  {cat:"Coctelería clásica",name:"Cuba Libre",family:"Highball",hasIngr:true,
    ...
    method:"Añade el ron blanco y el zumo de lima a un vaso con hielo. Completa con Pepsi y remueve suavemente.",
   glass:"Vaso largo",
   prices:[{label:"cóctel",p:11}]},
